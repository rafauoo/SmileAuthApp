...
def rename_videos():
    for num, file in enumerate(
        os.listdir(os.path.abspath(os.path.join(os.sep, ROOT_DIR, "videos_new")))
    ):
        ...
        if "deliberate" in file:
            os.rename(
                e_file,
                os.path.join(
                    os.sep, ROOT_DIR, "videos_new", f"{num+1:04}_deliberate.mp4"
                ),
            )
        if "spontaneous" in file:
            os.rename(
                e_file,
                os.path.join(
                    os.sep, ROOT_DIR, "videos_new", f"{num+1:04}_spontaneous.mp4"
                ),
            )
